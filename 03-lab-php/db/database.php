...
class DatabaseHelper{
    ...
    public function getPosts($n=-1){
        $query = "SELECT idarticolo, titoloarticolo, anteprimaarticolo, 
                        imgarticolo, dataarticolo, nome 
    ...
    public function getAuthors(){
        $query = "SELECT username, nome, GROUP_CONCAT(DISTINCT nomecategoria) as argomenti FROM categoria,
